...
$productionNotes = getAllProductionNote($link);
...
<div class="row mt-5">
    ...
    ?>
            <div class="col-md-9 text-end mt-4 mt-md-0">
                <button class="btn btn-dark" type="button" onclick="NewProductionNote()"><i class="fa-solid fa-plus"></i> New Production Note</button>
            </div>
    <?php
        }
    }
...
<div class="row mt-5">
    <div class="col-md-8">
        <div class="table-title font-weight-bold mb-4 mt-0">Production Notes</div>
                            ...
                            <tbody>
                                ...
                                if (!empty($productionNotes)) {
                                    ...
                                    foreach ($productionNotes as $selectedArray) {
                                        ...
                                        $pn_number = $selectedArray['pn_number'];
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?= $LocationName ?></td>
                                            <th class="text-end"><?= number_format($production_cost, 2) ?></th>
                                            <td class="text-end"><span class="badge mt-2 bg-<?= $color ?>"><?= $active_status ?></span></td>
                                            <td class="text-end">
                                                <button class="mt-0 btn btn-sm btn-dark view-button" type="button" onclick="PrintPN('<?= $pn_number ?>')"><i class="fa-solid fa-print"></i> Print</button>
                                            </td>
                                        </tr>
                                <?php
                                    }
