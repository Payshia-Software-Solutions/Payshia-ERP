...
function OpenIndex () {
  ...
  function fetch_data () {
    $.ajax({
      url: 'assets/content/supplier/index.php',
      method: 'POST',
      data: {
...
function LoadPopUPContent (UpdateKey) {
  ...
  function fetch_data () {
    $.ajax({
      url: 'assets/content/supplier/popup-content.php',
      method: 'POST',
      data: {
        LoggedUser: LoggedUser,
        UserLevel: UserLevel,
...
function AddNewSupplier (is_active, UpdateKey) {
  LoadPopUPContent(UpdateKey)
}


function SaveSupplier (is_active, UpdateKey) {
  ...
  if (form.checkValidity()) {
    ...
    function fetch_data () {
      $.ajax({
        url: 'assets/content/supplier/save.php',
        method: 'POST',
        data: formData,
        contentType: false,
        processData: false,
...
function ChangeStatus (IsActive, UpdateKey) {
  ...
  function fetch_data () {
    $.ajax({
      url: 'assets/content/supplier/change-status.php',
      method: 'POST',
      data: {
        LoggedUser: LoggedUser,
