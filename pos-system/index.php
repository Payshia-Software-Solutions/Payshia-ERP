...
<body>
    ...
    <div class="d-flex" id="wrapper">
            ...
            <div class="col-12">
                <div class="top-bar p-2">
                    <div class="row">
                        ...
                        <div class="col-8 col-md-10 text-end button-set" style="display: flex-box;justify-content: space-between;">

                            <button type="button" class="btn btn-warning mr-2  text-white d-none d-lg-inline ">
                                <i class="fa-solid fa-right-left m-0"></i>
                                <p class="m-0">Return</p>
                            </button>
                            <button type="button" class="btn btn-danger mr-2  d-none d-lg-inline "><i class="fa-solid fa-money-bill-trend-up"></i>
                                <p class="mb-0">Refund</p>
                            </button>
                            <button type="button" class="btn btn-secondary mr-2  d-none d-lg-inline "><i class="fa-solid fa-gift"></i>
                                <p class="mb-0">Gift</p>
                            </button>
                            <button type="button" class="btn btn-success mr-2  d-none d-lg-inline "><i class="fa-solid fa-money-bill"></i>
                                <p class="mb-0">Expenses</p>
                            </button>
                            <button onclick="AddCustomer()" type="button" class="btn btn-primary mr-2 "><i class="fa-solid fa-user-plus"></i>
                                <p class="mb-0">Customer</p>
                            </button>
                            <button onclick="OpenSetting()" type="button" class="btn btn-dark mr-2  d-none d-lg-inline "><i class="fa-solid fa-gear"></i>
                                <p class="mb-0">Setting</p>
                            </button>
                            <button type="button" id="scrollToBottomButton" class="btn refresh-button mr-2  d-none d-lg-inline "><i class="fa-solid fa-arrows-down-to-line"></i>
                                <p class="mb-0">Down</p>
                            </button>
                            <button type="button" id="scrollToTopButton" class="btn refresh-button mr-2  d-none d-lg-inline "><i class="fa-solid fa-arrows-up-to-line"></i>
                                <p class="mb-0">Up</p>
                            </button>
                            <button type="button" class="btn select-table-button " onclick="SetTable()"><i class="fa-solid fa-table btn-icon"></i>
                                <p class="mb-0">Select Table</p>
                            </button>
                            <button type="button" onclick="OpenIndex()" class="btn refresh-button mr-2 "><i class="fa-solid fa-arrows-rotate"></i>
                                <p class="mb-0">New</p>
                            </button>
                        </div>
                    </div>
        ...
        <!-- Sidebar -->
        <div class="border-right d-none d-md-flex" id="sidebar" style="margin-top: 80px;">
            <div class="list-group list-group-flush">
                ...
                <a href="#" class="list-group-item list-group-item-action text-center" onclick="PromptCloseApp()">
        ...
        <!-- Page Content -->
        <div class="container-fluid pb-4 mt-3" id="index-content">
        </div>
        ...
        <script src="./assets/js/index-1.2.js"></script>
