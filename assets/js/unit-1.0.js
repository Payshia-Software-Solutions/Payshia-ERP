...
function OpenIndex () {
  ...
  function fetch_data () {
    $.ajax({
      url: 'assets/content/unit-of-measurement/index.php',
      method: 'POST',
      data: {
...
function LoadPopUPContent (UpdateKey) {
  ...
  function fetch_data () {
    $.ajax({
      url: 'assets/content/unit-of-measurement/popup-content.php',
      method: 'POST',
      data: {
        LoggedUser: LoggedUser,
        UserLevel: UserLevel,
...
function AddNewUnit (is_active, UpdateKey) {
  LoadPopUPContent(UpdateKey)
}

function SaveUnit (is_active, UpdateKey) {
  ...
  if (form.checkValidity()) {
    ...
    function fetch_data () {
      $.ajax({
        url: 'assets/content/unit-of-measurement/save.php',
        method: 'POST',
        data: formData,
        contentType: false,
        processData: false,
...
function ChangeStatus (IsActive, UpdateKey) {
  ...
  function fetch_data () {
    $.ajax({
      url: 'assets/content/unit-of-measurement/change-status.php',
      method: 'POST',
      data: {
        LoggedUser: LoggedUser,
