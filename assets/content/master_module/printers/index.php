...
<div class="row mt-3">
    <div class="col-md-12">
        <div class="table-title font-weight-bold mb-3 mt-0">Setup POS Printers</div>
                                            ...
                                            <div class="bg-light p-3 rounded-3">
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-12 text-end">
                                                        <button onclick="UpdateSetting('kot_printer', document.getElementById('kotPrinter-<?= $selectedArray['location_id'] ?>').value, '<?= $selectedArray['location_id'] ?>')" type="button" class="btn btn-dark btn-sm"><i class="fa-solid fa-floppy-disk"></i> Save Printer</button>
                                                    ...
                                                    <div class="col-12 text-end">
                                                        <button onclick="UpdateSetting('kotPrintMethod', document.getElementById('kotPrinterMethod-<?= $selectedArray['location_id'] ?>').value, '<?= $selectedArray['location_id'] ?>')" type="button" class="btn btn-dark btn-sm"><i class="fa-solid fa-floppy-disk"></i> Save Method</button>
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="bg-light p-3 rounded-3">
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-12 text-end">
                                                        <button onclick="UpdateSetting('receipt_printer', document.getElementById('receiptPrinter-<?= $selectedArray['location_id'] ?>').value, '<?= $selectedArray['location_id'] ?>')" type="button" class="btn btn-dark btn-sm"><i class="fa-solid fa-floppy-disk"></i> Save Printer</button>
                                                    ...
                                                    <div class="col-12 text-end">
                                                        <button onclick="UpdateSetting('receiptPrintMethod', document.getElementById('receiptPrintMethod-<?= $selectedArray['location_id'] ?>').value, '<?= $selectedArray['location_id'] ?>')" type="button" class="btn btn-dark btn-sm"><i class="fa-solid fa-floppy-disk"></i> Save Method</button>
                                                    </div>
