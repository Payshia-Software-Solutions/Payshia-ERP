        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-4 offset-4">
                    ...
                    <select class="form-control" name="studentBatch" id="studentBatch" onchange="GetUploadExcelNew(this.value, document.getElementById('orderType').value)">
                ...
                <div class="col-4">
                    ...
                    <select class="form-control" name="orderType" id="orderType" onchange="GetUploadExcelNew(document.getElementById('studentBatch').value, this.value)">
                        <option value="0">All</option>
                        <?php
                        if (!empty($Deliveries)) {
                ...
                <table class="table table-striped table-hover table-fixed" id="excel-order-table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">PackageDescription</th>
                            <th scope="col">ReceiverName</th>
                            <th scope="col">ReceiverAddress</th>
                            <th scope="col">ReceiverCity</th>
                            <th scope="col">ReceiverContactNo</th>
