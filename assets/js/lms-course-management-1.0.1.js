...
function PrintGameReport(gameTitle, studentBatch, userName, locationId) {
    ...
    var printWindow = window.open('report-viewer/lms-reports/game-reports/' + gameTitle + '?studentBatch=' + encodeURIComponent(studentBatch) + '&userId=' + encodeURIComponent(userName) + '&locationId=' + encodeURIComponent(locationId), '_blank');
