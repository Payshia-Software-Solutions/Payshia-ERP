...
$updateKey = 0;
$ButtonText = "Save";
$product_code = $product_name = $print_name = $display_name = $product_section = $product_department = $product_category = $product_unit = $product_description = $ImgURL =  $supplier_list = "";

$cost_price = $min_price = $selling_price = $wholesale_price = 0;
        ...
        <form class="add-class-form" id="add-form" action="" method="post">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control form-control-sm text-end" name="cost_price" id="cost_price" value="<?= $cost_price ?>" placeholder="0.00" required>
                </div>
                <div class="col-md-3">
                    <label class="">Selling Price</label>
                    <input type="text" class="form-control form-control-sm text-end" name="selling_price" id="selling_price" value="<?= $selling_price ?>" placeholder="0.00" required>
                </div>
                <div class="col-md-3">
                    <label class="">Minimum Price</label>
                    <input type="text" class="form-control form-control-sm text-end" name="min_price" id="min_price" value="<?= $min_price ?>" placeholder="0.00" required>
                </div>
                <div class="col-md-3">
                    <label class="">Wholesale Price</label>
                    <input type="text" class="form-control form-control-sm text-end" name="wholesale_price" id="wholesale_price" value="<?= $wholesale_price ?>" placeholder="0.00" required>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control form-control-sm" name="item_location" id="ItemLocation" required>
                        ...
                        ?>
                                ?>
                                <option <?= ($selected_array['location_id'] == $product_category) ? 'selected' : '' ?> value="<?= $selected_array['location_id'] ?>"><?= $selected_array['location_name'] ?></option>
                        <?php
                            }
                        }
                        ?>
