...
if ($stewardId === "0") {
    ...
    $stewardFullName = $stewards[$stewardId]['first_name'] . " " . $stewards[$stewardId]['last_name'];
    $stewardName = $stewards[$stewardId]['first_name'];
}
...
<body>
    ...
    <div class="inv" id="inv">
        ...
        <table class="totals">
            <tr>
                <td colspan="2" <?= $fontClass ?>><?= $textArray['charge_amount'][$LanguageMode] ?></td>
                <td class="text-right" <?= $fontClass ?>><?php echo number_format($service_charge, 2); ?></td>
            </tr>
            <tr>
