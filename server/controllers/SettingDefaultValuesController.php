<?php
require_once './models/SettingDefaultValues.php';

class SettingDefaultValuesController
{
    private $model;

    public function __construct($pdo)
    {
        $this->model = new SettingDefaultValues($pdo);
    }
    ...
    public function createRecord()
    {
        ...
        if (isset($data['settingName'], $data['defaultValue'])) {
