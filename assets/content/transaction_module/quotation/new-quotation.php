...
<div class="row my-4">
    <div class="col-12">
        <div class="add-class-form" id="">
            ...
            <div class="row">
                <div class="col-12 text-end"><button class="btn-warning btn" onclick="NewQuotation()">
            ...
            <h1 class="site-title">Quotation</h1>
            ...
            <div class="row mb-3 mt-5">
                <div class="col-12 text-end">
                    <button class="mt-0 mb-1 btn  btn-success view-button" type="button" onclick="ProcessQuotation(0,2)"><i class="fa-solid fa-check"></i> Proceed</button>
                </div>
            </div>
