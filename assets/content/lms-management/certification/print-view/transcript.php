...
<div class="main-content">
    ...
    <div class="content">
        ...
        <p>This is to clarify that <span class="text-normal"><?= capitalizeWordsWithSpaceAfterFullStop($UserInfo['first_name']) ?> <?= capitalizeWordsWithSpaceAfterFullStop($UserInfo['last_name']) ?></span> has Successfully
        ...
        <div class="sp-note">Note: This Certification letter was issued by the Ceylon Pharma College on <span class="text-bold"><?= $ConvocationDate ?></span> at the <span class="text-bold"><?= $ConvocationPlace ?></span></div>
