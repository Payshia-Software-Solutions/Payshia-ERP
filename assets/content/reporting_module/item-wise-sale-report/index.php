...
<h4 class="border-bottom pb-2">Item Wise Sale Report</h4>
<form id="report-form" action="post">
    <div class="row">
        ...
        <div class="col-12 col-md-3 text-end">
            ...
            <button class="mb-0 btn action-button btn-success view-button" type="button" onclick="GetItemWiseSaleReport()"><i class="fa-solid fa-eye"></i> Get</button>
            <button class="mb-0 btn action-button btn-dark view-button" type="button" onclick="PrintItemWiseSaleReport()"><i class="fa-solid fa-print"></i> Print</button>
        </div>
